...
Begin by asking the user for their high-level project idea. Your goal is to understand what they want to *create*.
...
Present this to the user as the "Project Scaffolding Package," ready to be used in AI Studio.
